...
const ACTION_COVERAGE = [
  ...
  { action: "ai_chat.threads.update", method: "PATCH", endpoint: "/api/portal/ai-chat/threads/[threadId]" },
  { action: "ai_chat.threads.delete", method: "DELETE", endpoint: "/api/portal/ai-chat/threads/[threadId]" },
  { action: "ai_chat.threads.duplicate", method: "POST", endpoint: "/api/portal/ai-chat/threads/[threadId]/duplicate" },
  { action: "ai_chat.threads.share.get", method: "GET", endpoint: "/api/portal/ai-chat/threads/[threadId]/share" },
  ...
  { action: "ai_outbound_calls.campaigns.knowledge_base.upload", method: "POST", endpoint: "/api/portal/ai-outbound-calls/campaigns/[campaignId]/knowledge-base/upload" },
  { action: "ai_outbound_calls.campaigns.manual_call", method: "POST", endpoint: "/api/portal/ai-outbound-calls/campaigns/[campaignId]/manual-call" },
  { action: "ai_outbound_calls.campaigns.messages_knowledge_base.sync", method: "POST", endpoint: "/api/portal/ai-outbound-calls/campaigns/[campaignId]/messages-knowledge-base/sync" },
  { action: "ai_outbound_calls.campaigns.messages_knowledge_base.upload", method: "POST", endpoint: "/api/portal/ai-outbound-calls/campaigns/[campaignId]/messages-knowledge-base/upload" },
  { action: "ai_outbound_calls.campaigns.preview_message_reply", method: "POST", endpoint: "/api/portal/ai-outbound-calls/campaigns/[campaignId]/preview-message-reply" },
  { action: "ai_outbound_calls.campaigns.sync_agent", method: "POST", endpoint: "/api/portal/ai-outbound-calls/campaigns/[campaignId]/sync-agent" },
  { action: "ai_outbound_calls.campaigns.sync_chat_agent", method: "POST", endpoint: "/api/portal/ai-outbound-calls/campaigns/[campaignId]/sync-chat-agent" },
  { action: "ai_outbound_calls.contacts.search", method: "GET", endpoint: "/api/portal/ai-outbound-calls/contacts/search" },
  { action: "ai_outbound_calls.cron.run", method: "GET", endpoint: "/api/portal/ai-outbound-calls/cron" },
