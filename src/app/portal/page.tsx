          ...
          <div className="mx-auto max-w-6xl px-6 py-14 sm:py-16">
            <div className="max-w-3xl">
              ...
              <p className="mt-4 text-base text-[color:rgba(255,255,255,0.86)] sm:text-lg">
                Turn modules on, manage billing, and track hours saved. You’ll always know what’s active and what’s next.
              </p>
              ...
              <div className="mt-8 grid grid-cols-1 gap-3 sm:grid-cols-3">
                ...
                <div className="rounded-3xl border border-[color:rgba(255,255,255,0.18)] bg-[color:rgba(255,255,255,0.08)] p-5">
                  ...
                  <div className="mt-2 text-sm text-[color:rgba(255,255,255,0.80)]">
                    Add modules in minutes when you’re ready.
                  </div>
                </div>
                <div className="rounded-3xl border border-[color:rgba(255,255,255,0.18)] bg-[color:rgba(255,255,255,0.08)] p-5">
          ...
          <div className="mx-auto max-w-6xl px-6 py-12">
            ...
            <div className="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-3">
              ...
              <div className="rounded-3xl border border-[color:rgba(29,78,216,0.25)] bg-white p-6 shadow-sm">
                ...
                <div className="text-xs text-zinc-500">/ month</div>
                <div className="mt-4 text-sm text-zinc-700">
                  For teams that want consistent leads and bookings.
                </div>
                <div className="mt-4 space-y-2 text-sm text-zinc-700">
              ...
              <div className="rounded-3xl border border-zinc-200 bg-zinc-50 p-6">
                ...
                <div className="text-xs text-zinc-500">/ month</div>
                <div className="mt-4 text-sm text-zinc-700">
                  Full automation stack plus advanced follow-up.
                </div>
                <div className="mt-4 space-y-2 text-sm text-zinc-700">
            ...
            <div className="flex flex-col items-start justify-between gap-4 sm:flex-row sm:items-center">
              <div>
                ...
                <div className="mt-1 text-sm text-zinc-700">
                  Create your portal account, then activate the modules you want.
                </div>
              </div>
