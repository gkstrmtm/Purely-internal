...
export const portalSidebarButtonBaseClass =
  "w-full rounded-2xl px-2.5 py-1.5 text-left text-[13px] font-medium transition-colors duration-150 focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-ink/60";
...
export const portalSidebarMetaTextClass = "mt-0.5 text-[11px] text-zinc-500";

export const portalSidebarIconActionButtonClass =
  "inline-flex h-8 w-8 items-center justify-center rounded-2xl bg-transparent text-base font-semibold text-zinc-700 transition-colors duration-150 hover:bg-zinc-50 hover:text-zinc-900 disabled:cursor-not-allowed disabled:opacity-60";
...
export function IconReceptionistActivity({ className }: IconProps) {
  return (
    <svg width="100%" height="100%" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={className} aria-hidden="true">
      <path d="M22 12H18L15 21L9 3L6 12H2" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}

export function IconReceptionistTesting({ className }: IconProps) {
  return (
    <svg width="100%" height="100%" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={className} aria-hidden="true">
...
export function IconMissedCallTextBack({ className }: IconProps) {
  return (
    <svg width="100%" height="100%" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={className} aria-hidden="true">
...
export function IconCalls({ className }: IconProps) {
  return <IconPhoneCall size={20} className={className} />;
}
...
export function IconNewsletterInternal({ className }: IconProps) {
  return (
    <svg width="100%" height="100%" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={className} aria-hidden="true">
...
export function IconNewsletterExternal({ className }: IconProps) {
  return (
    <svg width="100%" height="100%" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={className} aria-hidden="true">
...
export function IconReviewRequests({ className }: IconProps) {
  return (
    <svg width="100%" height="100%" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={className} aria-hidden="true">
...
export function IconAppointments({ className }: IconProps) {
  return <IconCalendar size={20} className={className} />;
}
...
export function IconReminders({ className }: IconProps) {
  return (
    <svg width="100%" height="100%" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={className} aria-hidden="true">
...
export function IconSidebarSettings({ className }: IconProps) {
  return <IconSettingsGlyph size={20} className={className} />;
}

export function IconActiveFunnels({ className }: IconProps) {
  return <IconFunnel size={20} className={className} />;
}
