...
export function IconPlusGlyph({ size = 18, className, title }: PortalIconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconMinusGlyph({ size = 18, className, title }: PortalIconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconCloseGlyph({ size = 18, className, title }: PortalIconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconCheckGlyph({ size = 18, className, title }: PortalIconProps) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      {title ? <title>{title}</title> : null}
      <path d="M5 12.5L9.5 17L19 7.5" stroke="currentColor" strokeWidth="2.25" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}

export function IconMoreGlyph({ size = 18, className, title }: PortalIconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconGlobeGlyph({ size = 18, className, title }: PortalIconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconRedo({ size = 18, className, title }: PortalIconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconUpload({ size = 18, className, title }: PortalIconProps) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      />
      <path
        d="M4 15V18C4 19.6569 5.34315 21 7 21H17C18.6569 21 20 19.6569 20 18V15"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinecap="round"
        strokeLinejoin="round"
