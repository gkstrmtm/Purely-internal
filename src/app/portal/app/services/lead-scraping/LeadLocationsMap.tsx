...
export default function LeadLocationsMap({
  ...
  return (
    <div className="pa-lead-map relative h-full min-h-[50svh] overflow-hidden bg-white">
      <div className="pointer-events-none absolute inset-x-0 top-0 z-40 h-24 bg-[linear-gradient(180deg,rgba(255,255,255,0.92),rgba(255,255,255,0))]" />
      <div className="pointer-events-none absolute inset-y-0 left-0 z-30 w-px bg-zinc-200/90" />

      <div className={`pointer-events-none absolute left-4 top-4 z-1200 rounded-[1.35rem] border border-white/60 px-3.5 py-2.5 text-xs font-semibold text-zinc-700 ${portalGlassSectionClass}`}>
