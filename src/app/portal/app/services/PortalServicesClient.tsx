    ...
    <div className="mx-auto w-full max-w-6xl">
      ...
      <div className="mt-6 grid grid-cols-1 gap-4 lg:grid-cols-[0.8fr_0.8fr_0.8fr_1.4fr]">
        <div className="rounded-3xl border border-zinc-200 bg-white p-5">
          <div className="text-xs font-medium text-zinc-500">Ready now</div>
        ...
        <div className="rounded-3xl border border-amber-200 bg-amber-50 p-5">
          <div className="text-xs font-medium text-amber-700">Needs setup</div>
        ...
        <div className="rounded-3xl border border-zinc-200 bg-zinc-50 p-5">
          <div className="text-xs font-medium text-zinc-500">Unavailable</div>
        ...
        <div className="rounded-3xl border border-zinc-200 bg-white p-5">
          <div className="text-xs font-medium text-zinc-500">Next move</div>
