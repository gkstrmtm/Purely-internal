...
export function PortalHelpLink() {
  ...
  return (
    <Link
      ...
      aria-label="Help"
      title="Help"
      className="group relative inline-flex h-10 w-10 items-center justify-center rounded-xl border border-zinc-200 bg-white text-zinc-700 transition-all duration-150 hover:scale-[1.04] hover:bg-zinc-50 hover:text-zinc-900 hover:shadow-sm focus:outline-none focus-visible:ring-2 focus-visible:ring-zinc-400/40"
    >
      <svg
        width="18"
        height="18"
