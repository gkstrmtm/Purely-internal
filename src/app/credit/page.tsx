        ...
        <div className="mx-auto max-w-6xl px-6 py-14 sm:py-16">
          <div className="grid grid-cols-1 gap-10 md:grid-cols-2 md:items-center">
            <div className="max-w-3xl">
              ...
              <p className="mt-4 text-base text-[rgba(255,255,255,0.86)] sm:text-lg">
              ...
              <div className="mt-7 flex flex-col gap-3 sm:flex-row">
                <Link
                  ...
                  className="inline-flex items-center justify-center rounded-2xl bg-white px-6 py-3 text-base font-semibold text-(--color-brand-blue) transition-all duration-150 hover:-translate-y-0.5 hover:bg-zinc-50"
                >
                  Get started
                </Link>
                <Link
                  href="/credit/login"
                  className="inline-flex items-center justify-center rounded-2xl bg-(--color-brand-pink) px-6 py-3 text-base font-semibold text-white transition-transform duration-150 hover:-translate-y-0.5 hover:opacity-95"
                >
                  Sign In
                </Link>
              </div>
              ...
              <div className="mt-8 grid grid-cols-1 gap-3 sm:grid-cols-3">
                <div className="rounded-3xl border border-[rgba(255,255,255,0.18)] bg-[rgba(255,255,255,0.08)] p-5">
                  <div className="text-sm font-semibold">Credit-focused app</div>
                  <div className="mt-2 text-sm text-[rgba(255,255,255,0.80)]">
            ...
            <div className="hidden md:block">
              <div className="relative overflow-hidden rounded-3xl border border-white/15 bg-[rgba(255,255,255,0.06)] p-6 shadow-[0_18px_45px_rgba(0,0,0,0.22)]">
                ...
                <div className="relative">
                  <div className="text-xs font-medium text-white/75">Credit flow</div>
                  ...
                  <div className="mt-6 grid grid-cols-3 gap-3">
                    {[
                      ...
                      <div key={n.title} className="rounded-2xl border border-white/15 bg-[rgba(0,0,0,0.12)] p-4">
