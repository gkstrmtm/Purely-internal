...
function selectManualSlugs(opts: { message: string; url?: string }): string[] {
  ...
  // Booking tabs (these are separate service routes but often resolve to Booking with a tab).
  ...
  // Keyword-driven adds for common cross-cutting topics.
  ...
  // Tags/title matching as a fallback.
  ...
  // Ensure we don't accidentally inject an absurd amount of text.
