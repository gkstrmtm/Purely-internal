  ...
  return (
    <main className="min-h-screen bg-zinc-950 px-6 py-12 text-zinc-100">
      <div className="mx-auto max-w-2xl rounded-4xl border border-white/10 bg-white/5 p-8 shadow-2xl shadow-black/30 backdrop-blur">
        <div className="inline-flex items-center rounded-full border border-emerald-400/30 bg-emerald-400/10 px-3 py-1 text-xs font-semibold uppercase tracking-[0.18em] text-emerald-200">
        ...
        {result.ok ? (
          <div className="mt-6 grid gap-3 rounded-3xl border border-white/10 bg-black/20 p-4 text-sm text-zinc-200 sm:grid-cols-2">
            <div>
              <div className="text-[11px] font-semibold uppercase tracking-[0.14em] text-zinc-400">Offer</div>
              <div className="mt-1 font-medium text-white">{offerLabel}</div>
            </div>
            <div>
              <div className="text-[11px] font-semibold uppercase tracking-[0.14em] text-zinc-400">Recorded at</div>
              <div className="mt-1 font-medium text-white">{new Date(result.confirmedAt).toLocaleString()}</div>
            </div>
            <div>
              <div className="text-[11px] font-semibold uppercase tracking-[0.14em] text-zinc-400">Linked handoff</div>
              <div className="mt-1 font-medium text-white">{result.handoffEventId ? "Matched" : "Not linked"}</div>
            </div>
            <div>
              <div className="text-[11px] font-semibold uppercase tracking-[0.14em] text-zinc-400">Linked contact</div>
