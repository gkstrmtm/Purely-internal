...
export async function generateMetadata({
  ...
  const newsletter = await prisma.clientNewsletter
    ...
    .catch(() => null);
  if (!newsletter) return { title: host, robots: { index: false, follow: false } };
...
export default async function CustomDomainInternalNewsletterPage({
  params,
}: {
  params: Promise<{ domain: string; newsletterSlug: string }>;
}) {
