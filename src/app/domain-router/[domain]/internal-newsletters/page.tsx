...
export default async function CustomDomainInternalNewslettersIndexPage({
  ...
  const hostedNewsletterPage = await (prisma as any).hostedPageDocument.findFirst({
    where: { ownerId: site.ownerId, service: "NEWSLETTER", pageKey: "newsletter_home" },
  ...
  const newsletterArchive = (
    <HostedNewsletterArchive
      ...
      basePath="/internal-newsletters"
      emptyTitle="No internal newsletters yet."
        ...
        {hasHostedCustomHtml ? (
          renderHostedCustomHtmlTemplate({
            ...
            textTokens: {
              ...
              PAGE_TITLE: "Internal newsletters",
              PAGE_DESCRIPTION: `Team-only updates from ${brandName}.`,
              SITE_HANDLE: host,
            },
