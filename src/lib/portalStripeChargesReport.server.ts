...
export type StripeChargesRangeKey = "7d" | "30d";

export function clampStripeChargesRangeKey(value: string | null): StripeChargesRangeKey {
...
function startForRange(range: StripeChargesRangeKey, now: Date): Date {
...
export type StripeChargesReportPayload =
  | {
      ok: true;
      range: StripeChargesRangeKey;
      startIso: string;
      endIso: string;
      currency: string;
...
export async function getStripeChargesReportForOwner(ownerId: string, range: StripeChargesRangeKey): Promise<StripeChargesReportPayload> {
