...
const REQUIRED_MEDIA_GROWTH_COLUMNS = [
  "id",
  "ownerId",
  "mediaItemId",
  "workflowState",
...
async function growthSchemaLooksReady(): Promise<boolean> {
  try {
    ...
    return REQUIRED_MEDIA_GROWTH_COLUMNS.every((column) => available.has(column));
  } catch {
    return false;
  }
}
...
CREATE TABLE IF NOT EXISTS "PortalMediaGrowthProfile" (
  ...
  "providerDestinationType" TEXT,
  "providerDestinationId" TEXT,
  "providerDestinationLabel" TEXT,
  "providerAccountLabel" TEXT,
  "providerScheduledForAt" TIMESTAMP(3),
  "providerQueuedAt" TIMESTAMP(3),
  "providerPendingAt" TIMESTAMP(3),
  "queueOrder" INTEGER,
  ...
  CONSTRAINT "PortalMediaGrowthProfile_pkey" PRIMARY KEY ("id")
      ...
      `ALTER TABLE "PortalMediaGrowthProfile" ADD COLUMN IF NOT EXISTS "providerDestinationType" TEXT;`,
      `ALTER TABLE "PortalMediaGrowthProfile" ADD COLUMN IF NOT EXISTS "providerDestinationId" TEXT;`,
      `ALTER TABLE "PortalMediaGrowthProfile" ADD COLUMN IF NOT EXISTS "providerDestinationLabel" TEXT;`,
      `ALTER TABLE "PortalMediaGrowthProfile" ADD COLUMN IF NOT EXISTS "providerAccountLabel" TEXT;`,
      `ALTER TABLE "PortalMediaGrowthProfile" ADD COLUMN IF NOT EXISTS "providerScheduledForAt" TIMESTAMP(3);`,
      `ALTER TABLE "PortalMediaGrowthProfile" ADD COLUMN IF NOT EXISTS "providerQueuedAt" TIMESTAMP(3);`,
      `ALTER TABLE "PortalMediaGrowthProfile" ADD COLUMN IF NOT EXISTS "providerPendingAt" TIMESTAMP(3);`,
      ...
      `ALTER TABLE "PortalMediaGrowthProfile" ADD COLUMN IF NOT EXISTS "providerStatus" TEXT;`,
      ...
      `ALTER TABLE "PortalMediaGrowthProfile" ADD COLUMN IF NOT EXISTS "providerRetryEligible" BOOLEAN;`,
      `ALTER TABLE "PortalMediaGrowthProfile" ADD COLUMN IF NOT EXISTS "providerRetryAt" TIMESTAMP(3);`,
      ...
      `CREATE INDEX IF NOT EXISTS "PortalMediaGrowthProfile_ownerId_providerScheduledForAt_idx" ON "PortalMediaGrowthProfile"("ownerId", "providerScheduledForAt");`,
      `CREATE INDEX IF NOT EXISTS "PortalMediaGrowthProfile_ownerId_providerPublishState_providerScheduledForAt_idx" ON "PortalMediaGrowthProfile"("ownerId", "providerPublishState", "providerScheduledForAt");`,
      `
DO $$
BEGIN
  IF NOT EXISTS (
