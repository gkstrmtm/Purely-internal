  ...
  const body = (
    <div className="fixed inset-0 z-(--pa-variable-picker-backdrop-z,8100)" aria-hidden>
      ...
      >
        <div
          className={classNames(
            "flex w-full max-w-lg flex-col overflow-hidden rounded-3xl",
        ...
        >
          <div className="shrink-0 border-b border-white/30 p-4">
          ...
          <div className="min-h-0 flex-1 overflow-y-auto p-4">
            {mode === "create" && canCreateCustom ? (
                    ...
                    <div className="mt-2 grid grid-cols-1 gap-2 sm:grid-cols-12 sm:items-end">
                      <div className="sm:col-span-7">
                        <input
                          ...
                          className="w-full rounded-2xl border border-white/35 bg-white/55 px-4 py-3 text-sm outline-none focus:border-white/60"
              ...
              <>
                ...
                <div className="mt-3 max-h-[50vh] overflow-y-auto rounded-2xl border border-white/30 bg-white/35">
                  {filtered.length ? (
                    filtered.map((v) => (
                      <button
                        key={`${v.group}:${v.key}`}
